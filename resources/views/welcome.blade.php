...
<div id="app">
    <div id="wrapper">
        ...
        <nav id="sidebar" v-show="!($route.path === '/' || $route.path === '/register')" style="display: none">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseSuppliers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <router-link to="/index-supplier" class="collapse-item">All Suppliers</router-link>
                        </div>
                    </div>
                </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav id="topbar" v-show="!($route.path === '/' || $route.path === '/register')" style="display: none" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
